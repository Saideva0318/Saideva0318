...
Production-grade, containerized ETL pipeline. Extracts from CSV/REST APIs, validates data quality (CRITICAL/WARNING checks), and loads into PostgreSQL via SQLAlchemy upsert. Includes APScheduler cron scheduling, rotating logs, multi-stage Docker, and GitHub Actions CI that spins up a real PostgreSQL service.
...
*"Building data pipelines that turn raw noise into business signal."*
