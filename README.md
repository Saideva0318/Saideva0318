...
![OpenAI](https://img.shields.io/badge/LLM%20APIs-OpenAI%20%2F%20Anthropic-412991?logo=openai&logoColor=white)
![pgvector](https://img.shields.io/badge/pgvector-Vector%20Search-336791?logo=postgresql&logoColor=white)
![LangChain](https://img.shields.io/badge/RAG-Retrieval%20Augmented%20Generation-1C3C3C)
![HuggingFace](https://img.shields.io/badge/Embeddings-Sentence%20Transformers-FFD21E?logo=huggingface&logoColor=black)
...
![Python](https://img.shields.io/badge/Python-3.11-blue?logo=python) ![pgvector](https://img.shields.io/badge/pgvector-Vector%20Search-336791?logo=postgresql) ![LLM](https://img.shields.io/badge/LLM-Embeddings-412991?logo=openai) ![CI](https://github.com/Saideva0318/ai-recruitment-screening-agent/actions/workflows/ci.yml/badge.svg)
...
![Python](https://img.shields.io/badge/Python-3.11-blue?logo=python) ![Streaming](https://img.shields.io/badge/Streaming-Kafka--style-231F20?logo=apachekafka) ![ML](https://img.shields.io/badge/ML-Risk%20Scoring-F7931E?logo=scikitlearn) ![CI](https://github.com/Saideva0318/banking-fraud-detection-pipeline/actions/workflows/ci.yml/badge.svg)
...
<details>
<summary><strong>More projects</strong> (core data engineering & ML)</summary>
...
```mermaid
flowchart LR
    A[Operational / Streaming Sources<br/>HRIS · ERP · CDC · Transactions · Resumes] --> B[Ingestion & Validation<br/>Python · Airflow · Kafka-style]
    B --> C[Storage & Modeling<br/>Snowflake · PostgreSQL · pgvector]
    C --> D[Transformation<br/>dbt · Feature Engineering]
    D --> E[Intelligence Layer<br/>ML Risk Scoring · LLM Embeddings · RAG Matching]
    E --> F[Decisions<br/>Power BI · Recruiter/Fraud-Ops Dashboards]
```
